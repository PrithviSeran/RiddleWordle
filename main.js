var riddles = "QUESTIONS,ANSWERS\n" +
"\"With thieves I consort, With the Vilest, in short, I'm quite at ease in depravity, Yet all divines use me, And savants can't lose me, For I am the century of gravity.\",V\n" +
...
"\"I have holes on the top and bottom. I have holes on my left and on my right. And I have holes in the middle, Yet I still hold water.\",Sponge\n" +
...
"\"It occurs once in every minute. Twice in every moment and yet never in one hundred thousand years.\",M\n" +
...
"\"Every dawn begins with me. At dusk I'll be the first you see, and daybreak couldn't come without. What midday centers all about. Daises grow from me, I'm told. And when I come, I end all code, but in the sun I won't be found. Yet still, each day I'll be around.\",D\n" +
...
"\"What is it that makes tears without sorrow. And takes its journey to heaven?\",Smoke\n" +
...
"\"I go in hard and dry. I come out soft and sticky. You can blow me.\",Gum\n" +
...
"\"In the middle of night, I surround the gong. In the middle of sight, I end the song.\",G\n" +
...
"\"What is the thing which, once poured out, cannot be gathered again?\",Rain\n" +
...
"\"Where can you find roads without cars, forests without trees and cities without houses?\",Map\n" +
...
"\"What has four legs in the morning, two legs in the afternoon, and three legs in the evening?\",Man\n" +
...
"\"What happens every second, minute, month, and century. But not every hour, week, year, or decade?\",N\n" +
...
"\"Grows from the ground, bushes and grass, leaves of yellow, red and brown, unruly plants, get the axe, trim the hedge back down.\",Hair\n" +
...
"\"Two in a corner, one in a room, none in a house, but one in a shelter.\",R\n" +
...
"\"Weight in my belly, trees on my back, nails in my ribs, feet I do lack.\",Boat\n" +
...
"\"The beginning of eternity, the end of time and space, the beginning of every end, the end of every place.\",E\n" +
...
"\"Soldiers line up spaced with pride. Two long rows lined side by side. One sole unit can decide, if the rows will unit or divide.\",Zipper\n" +
...
"\"Long slim and slender. Dark as homemade thunder. Keen eyes and peaked nose. Scares the Devil wherever it goes.\",Snake\n" +
...
"\"It sat upon a willow tree, and sang softly unto me. Easing my pain and sorrow with its song. I wished to fly, but tarried long. And in my suffering, the willow was like a cool clear spring. What was it that helped me so? To spend my time in my woe.\",Bird\n" +
...
"\"I am never quite what I appear to be. Straight-forward I seem, but it's only skin deep. For mystery most often lies beneath my simple speech. Sharpen your wits, open your eyes, look beyond my exteriors, read me backwards, forwards, upside down. Think and answer the question...What am I?\",Riddle\n" +
...
"\"I am the third from a sparkle bright, I thrive throughout the day and night. Deep in the path of a cows white drink. I've had thousands of millions of years to think. But one of my creatures is killing me. And so the question I ask to thee, is who am I?\",Earth\n" +
...
"\"Toss me out of the window. You'll find a grieving wife. Pull me back but through the door, and watch someone give life.\",N\n" +
...
"\"Kings and queens may cling to power. And the jester's got his call. But, as you may all discover. The common one outranks them all.\",Ace\n" +
"\"Glittering points that downward thrust. Sparkling spears that never rust.\",Icicles\n" +
...
"\"You can see nothing else when you look in my face. I will look you in the eye and I will never lie.\",Mirror\n" +
...
"\"My first is in ocean but never in sea. My second's in wasp but never in bee. My third is in glider and also in flight. My whole is a creature that comes out at night.\",Owl\n" +
...
"\"It's true I bring serenity. And hang around the stars. But yet I live in misery, you'll find me behind bars. With thieves and villains I consort. In prison I'll be found. But I would never go to court. Unless there's more than one.\",S\n" +
...
"\"Black we are and much admired. Men seek us if they are tired. We tire the horse, comfort man. Guess this riddle if you can.\",Coal\n" +
...
"\"There is one in every corner and two in every room.\",O\n" +
...
"\"We are little airy creatures, all of different voice and features, one of us in glass is set. One of us you'll find in jet. Another you may see in tin. And the fourth a box within. If the fifth you should pursue, it can never fly from you.\",Vowels\n" +
...
"\"What's large on Saturday and Sunday. Small on Tuesday, Wednesday, and Thursday, and disappears on Monday and Friday?\",S\n" +
...
"\"I am a box that holds black and white keys without locks. Yet they can unlock your soul.\",Piano\n" +
...
"\"I have a title and many pages. I am a genteel of genteel descent. I am a killer veteran of war. I am a slave to my lord pledged to his service.\",Knight\n" +
...
"\"I am as simple as a circle. Worthless as a leader, but when I follow a group. Their strength increases tenfold. By myself I am practically nothing. Neither negative or positive.\",0\n" +
...
"\"My first is twice in apple but not once in tart. My second is in liver but not in heart. My third is in giant and also in ghost. Whole I'm best when I am toast.\",Pig\n" +
...
"\"What has a single eye but cannot see?\",A needle\n" +
...
"\"I occur once in a minute...\",The letter 'm'\n" +
"\"I pass before the sun, but make no shadow. What am I?\",wind\n" +
"\"Lighter than a feather, but a man cannot hold me for long...\",breath\n" +
"\"I have a hundred legs and cannot stand, a long neck but no head, and I eat the maid's life.\",broom";

riddles = riddles.split("\n");

for (let i = 0; i < riddles.length; i++)
{
    riddles[i] = riddles[i].split('"');
}
...
function pressKey(key) {
    ...
    if (activeTiles.length >= localStorage.getItem('answer').length) return
...
function submitGuess(){
    const activeTiles = [...getActiveTiles()]
    const joinString = getAnswerString(activeTiles)
    var lives = localStorage.getItem('lives');
    //store lives in local data 
    if (activeTiles.length !== localStorage.getItem('answer').length){
        showAlert("Not Enough Letters!")
        shakeTiles(activeTiles)
        return
    }
    else if (joinString === localStorage.getItem('answer').toLowerCase()){
        ...
        for (let i = 0; i < localStorage.getItem('answer').length; i++){
            activeTiles[i].textContent = "";
            delete activeTiles[i].dataset.state;
            delete activeTiles[i].dataset.letter;
        }

        document.getElementById("lives").innerHTML = ("Attempts = " + localStorage.getItem('lives'));
...
function getAnswerString(divs){
    var answer = ""

    for (let i = 0; i < divs.length; i++){
        answer = answer + divs[i].innerHTML
    }
...
function ogTemplate(){
    ...
    var riddleStore = localStorage.getItem('riddle')
    console.log(riddleStore)
    var livesNum = localStorage.getItem('lives');
    var answerStore = localStorage.getItem('answer')

    //console.log(answerStore.length, answerStore)

    if (riddleStore == null){

        localStorage.setItem('riddle', "What flies without wings? What passes all things? What mends all sorrow? What brings the morrow?")
        localStorage.setItem('lives', "5")
        localStorage.setItem('answer', "time")
        
        document.getElementById("lives").innerHTML = ("Attempts = 5"); 
        document.getElementById("riddle").innerHTML = ("What flies without wings? What passes all things? What mends all sorrow? What brings the morrow?");

        for (let i = 0; i < 4; i++){

            const newDiv = document.createElement("div");
            const divPar = document.getElementById("guess-grid");

            newDiv.classList.add("tile");
            divPar.appendChild(newDiv);
        }
    }
    else{
        document.getElementById("lives").innerHTML = ("Attempts = " + livesNum); 
        document.getElementById("riddle").innerHTML = (riddleStore); 

        for (let i = 0; i < answerStore.length; i++)
        {
            const newDiv = document.createElement("div");
            const divPar = document.getElementById("guess-grid");
...
function newTemplate(){
    ...
    var randIndex = Math.floor(Math.random() * 379);
    var riddleAnswer = ((riddles[randIndex][2]).split(","))[1];

    localStorage.removeItem('riddle')
    localStorage.setItem('riddle', riddles[randIndex][1])

    localStorage.removeItem('lives')
    localStorage.setItem('lives', '5')

    localStorage.removeItem('answer')
    localStorage.setItem('answer', riddleAnswer)

    location.reload()
}

function moveForvardButton(){
    var btn = document.createElement('button')

    btn.innerText = "Continue"

    var parentBtn = document.getElementById("continue") 

    btn.classList.add("continue")
    parentBtn.appendChild(btn)

    btn.addEventListener("click", newTemplate)
...
function deathScreen() {
    ...
    document.getElementById("reveal-answer").innerHTML = ("The answer was " + localStorage.getItem('answer'));
}